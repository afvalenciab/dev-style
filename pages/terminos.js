...
const TermsConditions = () => {
  return (
    <Container maxWidth="xl">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to DEV-STYLE.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            {' '}
            refers to DEV-STYLE, accessible from
            {' '}
            <a
              href="https://www.devstyle.com"
              rel="external nofollow noopener noreferrer"
              target="_blank">
              https://www.devstyle.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: devstyle@gmail.com</li>
      </ul>
    </Container>
  );
};
